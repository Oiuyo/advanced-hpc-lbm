...
int timestep(const t_param params, t_speed* cells, t_speed* tmp_cells, int* obstacles)
{
  ...
  float afw1 = params.density * params.accel / 9.f;
  float afw2 = params.density * params.accel / 36.f;
  ...
  for (int jj = 0; jj < params.ny; jj++)
  {
    ...
    ** we don't send a negative density */
    if (jj == params.ny - 2 && !obstacles[ii + jj*params.nx]
        && (cells[ii + jj*params.nx].speeds[3] - afw1) > 0.f
        && (cells[ii + jj*params.nx].speeds[6] - afw2) > 0.f
        && (cells[ii + jj*params.nx].speeds[7] - afw2) > 0.f)
    {
      /* increase 'east-side' densities */
      cells[ii + jj*params.nx].speeds[1] += afw1;
      cells[ii + jj*params.nx].speeds[5] += afw2;
      cells[ii + jj*params.nx].speeds[8] += afw2;
      /* decrease 'west-side' densities */
      cells[ii + jj*params.nx].speeds[3] -= afw1;
      cells[ii + jj*params.nx].speeds[6] -= afw2;
      cells[ii + jj*params.nx].speeds[7] -= afw2;
    }
      /*Propagate 
